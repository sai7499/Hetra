...
reInitiateRCU(data){
  const processData = data;
  const processId = this.apiService.api.reinitiateRCU.processId;
  const workflowId = this.apiService.api.reinitiateRCU.workflowId;
  const projectId = this.apiService.api.reinitiateRCU.projectId;
