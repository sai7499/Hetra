...
@Component({
  selector: 'app-viability-checks-pending-with-branch',
  templateUrl: './viability-checks-pending-with-branch.component.html',
  styleUrls: ['./viability-checks-pending-with-branch.component.css']
})
export class ViabilityChecksPendingWithBranchComponent implements OnInit {
