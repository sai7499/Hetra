...
@Component({
  selector: 'app-viability-checks-pending-with-me',
  templateUrl: './viability-checks-pending-with-me.component.html',
  styleUrls: ['./viability-checks-pending-with-me.component.css']
})
export class ViabilityChecksPendingWithMeComponent implements OnInit {
  constructor() {}
