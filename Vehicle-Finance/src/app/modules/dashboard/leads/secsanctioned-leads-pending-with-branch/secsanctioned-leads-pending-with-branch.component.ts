...
@Component({
  selector: 'app-secsanctioned-leads-pending-with-branch',
  templateUrl: './secsanctioned-leads-pending-with-branch.component.html',
  styleUrls: ['./secsanctioned-leads-pending-with-branch.component.css']
})
export class SecsanctionedLeadsPendingWithBranchComponent implements OnInit {
