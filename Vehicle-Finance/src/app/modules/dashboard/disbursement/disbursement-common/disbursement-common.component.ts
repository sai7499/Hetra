...
@Component({
  selector: 'app-disbursement-common',
  templateUrl: './disbursement-common.component.html',
  styleUrls: ['./disbursement-common.component.css']
})
export class DisbursementCommonComponent implements OnInit {
