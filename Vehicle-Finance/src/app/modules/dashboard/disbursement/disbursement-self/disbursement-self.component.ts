...
@Component({
  selector: 'app-disbursement-self',
  templateUrl: './disbursement-self.component.html',
  styleUrls: ['./disbursement-self.component.css']
})
export class DisbursementSelfComponent implements OnInit {
  ...
  getLeadDisburseDetails(Id, taskId?) {
    //this.router.navigateByUrl(`/pages/lead-section/${Id}`);


     this.router.navigateByUrl(`/pages/disbursement-section/${Id}`);
