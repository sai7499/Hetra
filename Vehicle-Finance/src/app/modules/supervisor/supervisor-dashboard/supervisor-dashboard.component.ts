...
export class SupervisorDashboardComponent implements OnInit {
  ...
  getReportersList() {
    ...
    this.supervisorService.getReportersList(data).subscribe((res: any) => {
      console.log(res);
      let resData = res.ProcessVariables.response;
      let resArray = JSON.parse(resData);
      console.log(resArray);
      this.TREE_DATA.push(resArray);
      this.dataSource.data = this.TREE_DATA;
