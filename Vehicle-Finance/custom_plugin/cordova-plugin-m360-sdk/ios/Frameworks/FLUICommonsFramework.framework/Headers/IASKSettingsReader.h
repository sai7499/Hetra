...
#define kIASKDestructive                      @"kIASKDestructive"
...
#define kIASKImageBundle                      @"ImageBundle"
#define kIASKCellImagePath                    @"IASKCellImagePath"
#define kIASKHideDetailText                   @"IASKHideDetailText"
...
#define kIASKPSCustomChildPaneSpecifier       @"PSCustomChildPaneSpecifier"
...
#define kIASKCustomTitleSubtitleCellSpecifier @"IASKCustomTitleSubtitleCellSpecifier"
#define kIASKPSSubTitleSpecifier              @"PSSubTitleSpecifier"
#define kIASDetailedRequired                  @"kIASDetailedRequired"

//Custom certificate cell
#define kCertificateCustomCell                @"IASKCustomCertificateCell"
#define kCertificateName                      @"IASKCertificateName"
#define kRootCertificateName                  @"IASKRootCertificateName"
#define kCertificateImageName                 @"IASKCertificateImageName"
#define kTrustStatus                          @"IASKTrustStatus"
#define kTrustImageName                       @"IASKTrustImageName"

// for trust chain
#define kTrustExpiryDate                      @"IASKTrustExpiryDate"
#define kIssuerName                           @"IASKIssuerName"

#define kIASUserData                          @"IASKUserData"
#define kaccessibilityLabel                   @"kaccessibilityLabel"
#define kaccessibilityHelpText                @"kaccessibilityHelpText"
...
#define kIASKAccessoryViewTapped              @"kIASKAccessoryViewTapped"
#define kIASKTextFieldEditingEnd              @"kIASKTextFieldEditingEnd"
