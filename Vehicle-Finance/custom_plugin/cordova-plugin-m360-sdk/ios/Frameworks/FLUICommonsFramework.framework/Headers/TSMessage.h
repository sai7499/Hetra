...
typedef NS_ENUM(NSInteger, TSMessageNotificationPosition) {
    ...
    TSMessageNotificationPositionCenterRoundCurved,
    TSMessageNotificationPositionCenterFullWidth,
...
+ (BOOL)dismissActiveNotificationIfNot:(TSMessageView *)currentView;
...
+ (BOOL)dismissNotification:(TSMessageView *)currentView;
@end
