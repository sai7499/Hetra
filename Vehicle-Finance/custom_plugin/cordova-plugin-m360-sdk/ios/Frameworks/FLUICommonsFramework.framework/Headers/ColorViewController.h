...
- (void)colorPopoverControllerDidSelectColor:(NSInteger)color;
...
@property (nonatomic, strong) NSString *currentPickedColor;
@property (nonatomic, assign) BOOL useGradientColors;
@end
