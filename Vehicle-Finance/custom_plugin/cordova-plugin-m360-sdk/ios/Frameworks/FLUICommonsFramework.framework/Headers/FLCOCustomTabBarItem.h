...
typedef void(^FLCOCustomTabBarItemActionHandler)(id tabBarItem);

@interface FLCOCustomTabBarItem : UIControl
...
@property (nonatomic, copy)  FLCOCustomTabBarItemActionHandler itemSelectionHandler;

/*
* Configure to NO if selection indicator below the item  not
*/
