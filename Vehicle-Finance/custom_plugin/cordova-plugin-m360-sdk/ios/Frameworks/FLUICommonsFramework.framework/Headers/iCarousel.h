...
@property (nonatomic) CGFloat upperClampOffset;
@property (nonatomic) CGFloat lowerClampOffset;
...
- (void)forCarousel:(__unused iCarousel *)carousel removeItem:(NSInteger) index;
...
- (void)carousel:(iCarousel *)carousel didSelectItemAtIndex:(NSInteger)index withGesture:(UIGestureRecognizer*)gesture forView:(UIView*)view;
