...
@property (nonatomic,readwrite) BOOL iconWidth2Requirement;
@property (nonatomic,readwrite) BOOL needPlainWhite;
@property (nonatomic,readwrite) BOOL doNotAddStatusBarHeight;
...
-(void)presentPopoverFromPoint:(CGPoint)fromPoint inViewController:(UIViewController *)controller;
-(void)presentPopoverFromPoint:(CGPoint)fromPoint inView:(UIView*)inputView;
