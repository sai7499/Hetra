...
- (NSString*)file;
- (id)defaultValue;
- (void)updateDefaultValue:(id)value;
...
-(UIImage *)getCertImage;
-(NSString *)getRootCertName;
-(NSInteger)getTrustStatus;
-(UIImage *)getTrustImage;

-(NSString *)getIssuerName;
-(NSString *)getCertExpiryDate;
-(NSString *)getAccessibilityLabel;
-(NSString *)getAccessibilityHelpText;
- (BOOL)hideDetailText;

-(BOOL)isDetailedRequiredForMultivalue;
