//
//  NSLayoutConstraint+MaaS360ConstarintAdditions.h
//  FLUICommons
//
...
@interface NSLayoutConstraint (MaaS360ConstarintAdditions)
...
+ (NSLayoutConstraint *)constraintToCenterViewVerticallyToSuperview:(UIView *)view withOffset:(CGFloat)offset;
...
//Harizontally + Vertically center with static height & width.
+ (NSArray*)constraintsToCenterAlignView:(UIView*)view withWidth:(CGFloat)width withHeight:(CGFloat)height;
